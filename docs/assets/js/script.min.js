...
import*as e from"./libs/three.module.js";import{OrbitControls as t}from"./libs/OrbitControls.js";import{GLTFLoader as n}from"./libs/GLTFLoader.js";import{RoughnessMipmapper as a}from"./libs/RoughnessMipmapper.js";let i,o,r,l,s,m,d,c=$("#camera").width(),p=$("#camera").height(),u=!1,g=null;function h(){o=new e.PerspectiveCamera(80,c/p,1,1e4),o.position.set(.29080384630096257,1.2129671431583753,9.972168461904127),r=new e.Scene,m=new e.Raycaster,r.background=new e.Color(9408918),l=new e.WebGLRenderer({alpha:!0,antialias:!0}),l.setClearColor(0,0),l.setPixelRatio(window.devicePixelRatio),l.setSize(c,p),l.toneMapping=e.ACESFilmicToneMapping,l.toneMappingExposure=.8,l.outputEncoding=e.sRGBEncoding,document.getElementById("camera").appendChild(l.domElement),d=new e.PMREMGenerator(l),d.compileEquirectangularShader(),new e.PMREMGenerator(l).compileEquirectangularShader(),i=new t(o,l.domElement),i.enableKeys=!1,i.target.set(0,0,0),i.enableZoom=!1,i.autoRotate=!0,i.enableDamping=!0,i.dampingFactor=.095,i.rotateSpeed=.05,i.minPolarAngle=.95,i.maxPolarAngle=1.57,i.update();const n=new e.HemisphereLight(16777215,4473924);n.position.set(0,200,0),r.add(n);let a=new e.AmbientLight(3355443),s=new e.DirectionalLight(16777215,1);r.add(a),r.add(s),f(),window.addEventListener("resize",E,!1),l.domElement.addEventListener("click",w,!1)}function w(e){u=!0,g&&clearTimeout(g),g=setTimeout((()=>{u=!1,i.autoRotate=!0,L()}),5e3)}function b(){let e=new a(l);(new n).setPath("./assets/models/").load("wshape.glb",(function(t){var n=c/1e3*15;n<9&&(n=9),s=t.scene,s.position.set(0,0,0),s.scale.set(n,n,n),s.traverse((function(t){t.isMesh&&e.generateMipmaps(t.material)})),e.dispose(),r.add(s),$("#loaderBox").hide(),M()}))}function f(t="thumbnail",n=!0){var a="wshape-"+t+".jpeg";let i=(new e.TextureLoader).setPath("assets/images/").load(a,(function(n){n.mapping=e.UVMapping,n.minFilter=e.LinearFilter;let a={generateMipmaps:!0,minFilter:e.LinearMipmapLinearFilter,magFilter:e.LinearFilter};r.background=new e.WebGLCubeRenderTarget(1200,a).fromEquirectangularTexture(l,n),r.environment=d.fromEquirectangular(n).texture,L(),"thumbnail"===t&&(b(),f("original",!1))}));i.minFilter=e.LinearFilter,i.encoding=e.sRGBEncoding}function E(){c=$("#camera").width(),p=$("#camera").height(),o.aspect=c/p,o.updateProjectionMatrix(),l.setSize(c,p)}function L(){u&&(i.rotateSpeed=.5,i.autoRotate=!1),l.render(r,o),i.update()}function M(){requestAnimationFrame(M),L()}h(),$("#nav-icon1").click((function(){$(this).toggleClass("open"),$(".menu-box").toggleClass("active")}));