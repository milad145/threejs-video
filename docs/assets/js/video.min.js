...
import*as e from"./libs/three.module.js";import{OrbitControls as t}from"./libs/OrbitControls.js";import{GLTFLoader as n}from"./libs/GLTFLoader.js";import{RoughnessMipmapper as i}from"./libs/RoughnessMipmapper.js";let a,r,o,l,s,m,c,d=$("#camera").width(),p=$("#camera").height(),u=!1,g=null,h=[{title:"Manifesto",href:"#"},{title:"Partners",href:"#"},{title:"Impact",href:"#"},{title:"Privacy Policy",href:"#"},{title:"Planet Heros",href:"#"}];function f(){r=new e.PerspectiveCamera(80,d/p,1,1e4),r.position.set(.29080384630096257,1.2129671431583753,9.972168461904127),o=new e.Scene,m=new e.Raycaster,o.background=new e.Color(9408918),l=new e.WebGLRenderer,l.setClearColor(0,0),l.setPixelRatio(window.devicePixelRatio),l.setSize(d,p),l.toneMapping=e.ACESFilmicToneMapping,l.toneMappingExposure=.8,l.outputEncoding=e.sRGBEncoding,document.getElementById("camera").appendChild(l.domElement),c=new e.PMREMGenerator(l),c.compileEquirectangularShader(),new e.PMREMGenerator(l).compileEquirectangularShader(),a=new t(r,l.domElement),a.enableKeys=!1,a.target.set(0,0,0),a.enableZoom=!1,a.autoRotate=!0,a.enableDamping=!0,a.dampingFactor=.095,a.rotateSpeed=.05,a.minPolarAngle=.95,a.maxPolarAngle=3,a.update();const n=new e.HemisphereLight(16777215,4473924);n.position.set(0,200,0),o.add(n);let i=new e.AmbientLight(3355443),s=new e.DirectionalLight(16777215,1);o.add(i),o.add(s);const u=new e.SphereGeometry(500,60,40);u.scale(-1,1,1);const g=document.getElementById("video");g.play();const h=new e.VideoTexture(g),f=new e.MeshBasicMaterial({map:h}),E=new e.Mesh(u,f);o.add(E),b(),window.addEventListener("resize",M,!1),l.domElement.addEventListener("click",w,!1)}function w(e){u=!0,g&&clearTimeout(g),g=setTimeout((()=>{u=!1,a.autoRotate=!0,L()}),5e3)}function b(){let e=new i(l);(new n).setPath("./assets/models/").load("wshape.glb",(function(t){var n=d/1e3*15;n<9&&(n=9),s=t.scene,s.position.set(0,0,0),s.scale.set(n,n,n),s.traverse((function(t){t.isMesh&&e.generateMipmaps(t.material)})),e.dispose(),o.add(s),$("#loaderBox").hide(),v()}))}function E(t="thumbnail",n=!0){var i="wshape-"+t+".jpeg";let a=(new e.TextureLoader).setPath("assets/images/").load(i,(function(n){n.mapping=e.UVMapping,n.minFilter=e.LinearFilter;let i={generateMipmaps:!0,minFilter:e.LinearMipmapLinearFilter,magFilter:e.LinearFilter};o.background=new e.WebGLCubeRenderTarget(1200,i).fromEquirectangularTexture(l,n),o.environment=c.fromEquirectangular(n).texture,L(),"thumbnail"===t&&(b(),E("original",!1))}));a.minFilter=e.LinearFilter,a.encoding=e.sRGBEncoding}function M(){d=$("#camera").width(),p=$("#camera").height(),r.aspect=d/p,r.updateProjectionMatrix(),l.setSize(d,p)}function L(){u&&(a.rotateSpeed=.5,a.autoRotate=!1),l.render(o,r),a.update()}function v(){requestAnimationFrame(v),L()}function P(){let e="";for(let t of h)e+=`<div class="menu-item"><a href="${t.href}" title="${t.title}">${t.title}</a></div>`;$(".menu-items").append(e)}f(),P(),$("#nav-icon1").click((function(){$(this).toggleClass("open"),$(".menu-box").toggleClass("active")}));