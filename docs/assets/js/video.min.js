...
import*as e from"./libs/three.module.js";import{OrbitControls as t}from"./libs/OrbitControls.js";import{GLTFLoader as n}from"./libs/GLTFLoader.js";import{RoughnessMipmapper as a}from"./libs/RoughnessMipmapper.js";let i,o,r,s,l,m,d,c=$("#camera").width(),p=$("#camera").height(),u=!1,g=null;function h(){o=new e.PerspectiveCamera(80,c/p,1,1e4),o.position.set(.29080384630096257,1.2129671431583753,9.972168461904127),r=new e.Scene,m=new e.Raycaster,r.background=new e.Color(9408918),s=new e.WebGLRenderer,s.setClearColor(0,0),s.setPixelRatio(window.devicePixelRatio),s.setSize(c,p),s.toneMapping=e.ACESFilmicToneMapping,s.toneMappingExposure=.8,s.outputEncoding=e.sRGBEncoding,document.getElementById("camera").appendChild(s.domElement),d=new e.PMREMGenerator(s),d.compileEquirectangularShader(),new e.PMREMGenerator(s).compileEquirectangularShader(),i=new t(o,s.domElement),i.enableKeys=!1,i.target.set(0,0,0),i.enableZoom=!1,i.autoRotate=!0,i.enableDamping=!0,i.dampingFactor=.095,i.rotateSpeed=.05,i.minPolarAngle=.95,i.maxPolarAngle=3,i.update();const n=new e.HemisphereLight(16777215,4473924);n.position.set(0,200,0),r.add(n);let a=new e.AmbientLight(3355443),l=new e.DirectionalLight(16777215,1);r.add(a),r.add(l);const u=new e.SphereGeometry(500,60,40);u.scale(-1,1,1);const g=document.getElementById("video");g.play();const h=new e.VideoTexture(g),E=new e.MeshBasicMaterial({map:h}),M=new e.Mesh(u,E);r.add(M),b(),window.addEventListener("resize",f,!1),s.domElement.addEventListener("click",w,!1)}function w(e){u=!0,g&&clearTimeout(g),g=setTimeout((()=>{u=!1,i.autoRotate=!0,M()}),5e3)}function b(){let e=new a(s);(new n).setPath("./assets/models/").load("wshape.glb",(function(t){var n=c/1e3*15;n<9&&(n=9),l=t.scene,l.position.set(0,0,0),l.scale.set(n,n,n),l.traverse((function(t){t.isMesh&&e.generateMipmaps(t.material)})),e.dispose(),r.add(l),$("#loaderBox").hide(),L()}))}function E(t="thumbnail",n=!0){var a="wshape-"+t+".jpeg";let i=(new e.TextureLoader).setPath("assets/images/").load(a,(function(n){n.mapping=e.UVMapping,n.minFilter=e.LinearFilter;let a={generateMipmaps:!0,minFilter:e.LinearMipmapLinearFilter,magFilter:e.LinearFilter};r.background=new e.WebGLCubeRenderTarget(1200,a).fromEquirectangularTexture(s,n),r.environment=d.fromEquirectangular(n).texture,M(),"thumbnail"===t&&(b(),E("original",!1))}));i.minFilter=e.LinearFilter,i.encoding=e.sRGBEncoding}function f(){c=$("#camera").width(),p=$("#camera").height(),o.aspect=c/p,o.updateProjectionMatrix(),s.setSize(c,p)}function M(){u&&(i.rotateSpeed=.5,i.autoRotate=!1),s.render(r,o),i.update()}function L(){requestAnimationFrame(L),M()}h(),$("#nav-icon1").click((function(){$(this).toggleClass("open"),$(".menu-box").toggleClass("active")}));