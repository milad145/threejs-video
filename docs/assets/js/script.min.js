...
import*as e from"./libs/three.module.js";import{OrbitControls as t}from"./libs/OrbitControls.js";import{GLTFLoader as i}from"./libs/GLTFLoader.js";import{RoughnessMipmapper as n}from"./libs/RoughnessMipmapper.js";let a,r,o,l,s,m,d,c=$("#camera").width(),p=$("#camera").height(),u=!1,g=null,h=[{title:"Manifesto",href:"#"},{title:"Partners",href:"#"},{title:"Impact",href:"#"},{title:"Privacy Policy",href:"#"},{title:"Planet Heros",href:"#"}];function f(){r=new e.PerspectiveCamera(80,c/p,1,1e4),r.position.set(.29080384630096257,1.2129671431583753,9.972168461904127),o=new e.Scene,m=new e.Raycaster,o.background=new e.Color(9408918),l=new e.WebGLRenderer({alpha:!0,antialias:!0}),l.setClearColor(0,0),l.setPixelRatio(window.devicePixelRatio),l.setSize(c,p),l.toneMapping=e.ACESFilmicToneMapping,l.toneMappingExposure=.8,l.outputEncoding=e.sRGBEncoding,document.getElementById("camera").appendChild(l.domElement),d=new e.PMREMGenerator(l),d.compileEquirectangularShader(),new e.PMREMGenerator(l).compileEquirectangularShader(),a=new t(r,l.domElement),a.enableKeys=!1,a.target.set(0,0,0),a.enableZoom=!1,a.autoRotate=!0,a.enableDamping=!0,a.dampingFactor=.095,a.rotateSpeed=.05,a.minPolarAngle=.95,a.maxPolarAngle=1.57,a.update();const i=new e.HemisphereLight(16777215,4473924);i.position.set(0,200,0),o.add(i);let n=new e.AmbientLight(3355443),s=new e.DirectionalLight(16777215,1);o.add(n),o.add(s),E(),window.addEventListener("resize",L,!1),l.domElement.addEventListener("click",w,!1)}function w(e){u=!0,g&&clearTimeout(g),g=setTimeout((()=>{u=!1,a.autoRotate=!0,a.rotateSpeed=.05,M()}),5e3)}function b(){let e=new n(l);(new i).setPath("./assets/models/").load("wshape.glb",(function(t){var i=c/1e3*15;i<9&&(i=9),s=t.scene,s.position.set(0,0,0),s.scale.set(i,i,i),s.traverse((function(t){t.isMesh&&e.generateMipmaps(t.material)})),e.dispose(),o.add(s),$("#loaderBox").hide(),P()}))}function E(t="thumbnail",i=!0){var n="wshape-"+t+".jpeg";let a=(new e.TextureLoader).setPath("assets/images/").load(n,(function(i){i.mapping=e.UVMapping,i.minFilter=e.LinearFilter;let n={generateMipmaps:!0,minFilter:e.LinearMipmapLinearFilter,magFilter:e.LinearFilter};o.background=new e.WebGLCubeRenderTarget(1200,n).fromEquirectangularTexture(l,i),o.environment=d.fromEquirectangular(i).texture,M(),"thumbnail"===t&&(b(),E("original",!1))}));a.minFilter=e.LinearFilter,a.encoding=e.sRGBEncoding}function L(){c=$("#camera").width(),p=$("#camera").height(),r.aspect=c/p,r.updateProjectionMatrix(),l.setSize(c,p)}function M(){u&&(a.rotateSpeed=.5,a.autoRotate=!1),l.render(o,r),a.update()}function P(){requestAnimationFrame(P),M()}function v(){let e="";for(let t of h)e+=`<div class="menu-item"><a href="${t.href}" title="${t.title}">${t.title}</a></div>`;$(".menu-items").append(e)}f(),v(),$("#nav-icon1").click((function(){$(this).toggleClass("open"),$(".menu-box").toggleClass("active")}));